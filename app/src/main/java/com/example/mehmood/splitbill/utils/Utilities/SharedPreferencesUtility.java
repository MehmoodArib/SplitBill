...
import android.content.SharedPreferences;
     ...
     * Usage:
     *
     * int sampleInt = SharedPreferencesUtility.getInstance(context).getInt(Key.SAMPLE_INT);
     * SharedPreferencesUtility.getInstance(context).put(Key.SAMPLE_INT, sampleInt);
     *
     * If SharedPreferencesUtility.getInstance(Context) has been called once, you can
    ...
    public class SharedPreferencesUtility {
        ...
        private SharedPreferencesUtility(Context context) {
            mPref = context.getSharedPreferences(USER_DATA, Context.MODE_PRIVATE);
        }


        public static SharedPreferencesUtility getInstance(Context context) {
            if (sSharedPrefs == null) {
                sSharedPrefs = new SharedPreferencesUtility(context.getApplicationContext());
            }
            return sSharedPrefs;
        }
